...
const images = [
  { src: "/assets/Images/banner3.jpg", text: ["Green Energy Solutions for Villages & Firms","Revolutionizing Rural Life with Green Energy","Renewable Energy for Factories"] }, // Top Large Image
