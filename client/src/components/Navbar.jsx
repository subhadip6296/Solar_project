...
const Navbar = () => {
  ...
  return (
    <>
      <motion.nav
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        className={`fixed w-full z-50 dark:bg-green-950  transition-all duration-300 ${isScrolled ? "bg-black shadow-lg" : "bg-white"}`}>
  ...
  `}
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-48 dark:bg-green-800 bg-white shadow-md rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                  <button
                    onClick={() =>
                      handleDownload(
